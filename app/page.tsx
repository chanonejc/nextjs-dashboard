...
import { inter, lusitana } from '@/app/ui/fonts' // Importing Lusitana dan Inter font barengan, ga usah import 2 kali di 2 baris;
      ...
      <div className="flex h-20 shrink-0 items-end rounded-lg bg-pink-500 p-4 md:h-52">
        ...
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          <p className={`text-xl text-gray-800 md:text-3xl md:leading-normal`}>
            <strong>Welcome to Chatal Digital House.</strong> This is the example for the{' '}
